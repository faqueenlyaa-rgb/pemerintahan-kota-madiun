...
const articles = [
{
  ...
  image2:
  'https://www.madiunkota.go.',
  title: {
...
},
{
  ...
  image2:
  'https://www.madiunkota.go.',
  title: {
    ...
    items: [
      {
        ...
        answer: 'Berita terbaru tentang Kota Madiun dapat diakses melalui halaman Madiun Terkini, Berita Pemerintahan, Madiun Today, Suara Madiun, dan kanal informasi resmi Pemerintah Kota Madiun.'
      },
      {
        question: 'Di mana saya bisa melihat pengumuman atau rilis resmi pemerintah kota?',
        answer: 'Pengumuman dan rilis resmi dapat dilihat melalui halaman Madiun Terkini pada bagian Pengumuman atau Rilis. Halaman tersebut disiapkan untuk menampilkan informasi resmi yang dibutuhkan masyarakat.'
      },
      {
        question: 'Bagaimana cara menyampaikan pengaduan atau aspirasi masyarakat?',
        answer: 'Pengaduan atau aspirasi dapat disampaikan melalui kanal resmi pemerintah kota, seperti website resmi, media sosial pemerintah, atau layanan pengaduan yang tersedia untuk masalah pelayanan publik, lingkungan, fasilitas umum, dan infrastruktur.'
      },
      {
        question: 'Bagaimana cara mendapatkan informasi layanan kependudukan?',
        answer: 'Informasi layanan kependudukan seperti KTP, Kartu Keluarga, pindah domisili, atau administrasi penduduk lainnya dapat diakses melalui menu Layanan Kependudukan atau kanal resmi perangkat daerah terkait.'
      },
      {
        question: 'Bagaimana cara mengajukan permohonan informasi publik?',
        answer: 'Permohonan informasi publik dapat diajukan melalui layanan PPID atau kanal informasi publik resmi. Layanan ini digunakan masyarakat untuk memperoleh informasi sesuai prosedur keterbukaan informasi publik.'
      },
      {
        question: 'Apakah semua layanan tersedia langsung di website ini?',
        answer: 'Website ini berfungsi sebagai portal informasi dan penghubung layanan. Beberapa informasi tersedia langsung di dalam website, sedangkan layanan tertentu diarahkan ke website atau aplikasi resmi instansi terkait.'
      }
    ]
  },
  en: {
    ...
    items: [
      {
        ...
        answer: 'The latest news about Madiun City can be accessed through the Madiun Terkini page, Government News, Madiun Today, Suara Madiun, and official information channels of the Madiun City Government.'
      },
      {
        question: 'Where can I find official announcements or city government releases?',
        answer: 'Official announcements and releases can be found on the Madiun Terkini page under the Announcement or Release sections.'
      },
      {
        question: 'How can citizens submit complaints or aspirations?',
        answer: 'Complaints or aspirations can be submitted through official city government channels, such as the official website, government social media, or available public complaint services.'
      },
      {
        question: 'How can I get information about population administration services?',
        answer: 'Information about ID cards, family cards, domicile transfer, or other population documents can be accessed through the Population Services menu or official channels of the related local office.'
      },
      {
        question: 'How can I request public information?',
        answer: 'Public information requests can be submitted through PPID services or official public information channels.'
      },
      {
        question: 'Are all services available directly on this website?',
        answer: 'This website functions as an information portal and service connector. Some information is available directly on the website, while certain services are directed to official websites or applications.'
      }
    ]
  }
};
  ...
  if (params.slug && !selectedArticle) {
    return (
      <PageShell>
        ...
        <div className="mt-10 rounded-[2rem] bg-white p-10 text-center shadow-sm border border-gray-100">
      ...
      <PageShell>
        <SEO
          ...
          structuredData={{
            ...
            description: selectedArticle.body[lang][0],
            image: [selectedArticle.image1, selectedArticle.image2],
            ...
            publisher: {
              ...
              logo: {
                '@type': 'ImageObject',
                url: 'https://www.madiunkota.go.id/image/Lambang_Kota_Madiun.png'
              }
            },
            mainEntityOfPage: {
              '@type': 'WebPage',
        ...
        structuredData={[
          {
            '@context': 'https://schema.org',
            '@type': 'CollectionPage',
            name: lang === 'en' ? 'Madiun City Government News' : 'Berita Pemerintahan Kota Madiun',
            description:
              lang === 'en'
...
function BackButton() {
  return (
    <Link
      to="/"
      className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-[#237227] font-semibold shadow hover:bg-gray-100 transition">
...
}: {article: (typeof articles)[number];lang: 'id' | 'en';text: (typeof uiText)['id'];index?: number;}) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 18 }}
      animate={{ opacity: 1, y: 0 }}
