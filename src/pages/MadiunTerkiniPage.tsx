  ...
  const services: ServiceItem[] = [
    {
      ...
      icon: 'https://www.madiunkota.go.id/image/Lambang_Kota_Madiun.png',
      isExternal: true,
    },
    {
    ...
    },
    {
      ...
      icon: 'https://madiuntoday.id/image/mtd.png',
      isExternal: true,
    },
    {
      title: t('madiunTerkini.suaraMadiun'),
      href: 'https://93fm.madiunkota.go.id/',
      icon: 'https://93fm.madiunkota.go.id/logo-putih.png',
      bg: 'bg-primary',
      isExternal: true,
    },
    {
      ...
      icon: 'https://ruangsatu.id/ruangsatu-logo.svg',
      isExternal: true,
    },
    {
